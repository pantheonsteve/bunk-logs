...
from.forms import BunkSelectionForm, BunkLogAdminForm
...
class BunkLogAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        if 'bunk_assignment' in form.base_fields:
            ...
            if bunk_id:
                form.base_fields['bunk_assignment'].queryset = CamperBunkAssignment.objects.filter(
                    bunk_id=bunk_id,
                    is_active=True
    ...
    search_fields = ('bunk_assignment__camper__first_name', 'bunk_assignment__camper__last_name')
    
    def get_camper_name(self, obj):
        return obj.bunk_assignment.camper
    get_camper_name.short_description = _('Camper')
    
    def get_bunk_name(self, obj):
        return obj.bunk_assignment.bunk.name
    get_bunk_name.short_description = _('Bunk')
    ...
    def select_bunk_view(self, request):
        ...
        return render(request, 'admin/bunklogs/bunklog/select_bunk.html', context)
