...
from .forms import CabinCsvImportForm, UnitCsvImportForm
from .models import Bunk, Cabin, Session, Unit
from .services.imports import import_cabins_from_csv, import_units_from_csv
...
class BunkAdmin(admin.ModelAdmin):
    ...
    activate_bunks.short_description = "Mark selected bunks as active"
    
    def deactivate_bunks(self, request, queryset):
        updated = queryset.update(is_active=False)
        self.message_user(request, f"{updated} bunks were deactivated.")
    deactivate_bunks.short_description = "Mark selected bunks as inactive"
